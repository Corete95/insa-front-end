...
describe("Month", () => {
  it("applies given classNames properly", () => {
    ...
    expect(
      wrapperClassName.includes("react-calendar__year-view__months__month")
    ).toBe(true);
  ...
  it("renders component with proper abbreviation", () => {
    const component = mount(
      <Month {...tileProps} date={new Date(2018, 0, 1)} month={2018} />
    );
  ...
  it("calls onClick callback when clicked and sends proper date as an argument", () => {
    ...
    const component = mount(
      <Month {...tileProps} date={date} onClick={onClick} />
    );
