...
function getDetailValue(_ref, index) {
  ...
  var detailValueFrom = [_dates.getBegin, _dates.getEnd][index](
    valueType,
    valuePiece
  );
...
var Calendar = /*#__PURE__*/ (function (_Component) {
  ...
  function Calendar() {
    ...
    _defineProperty(_assertThisInitialized(_this), "drillDown", function (
      nextActiveStartDate,
      event
    ) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (
      ...
      if (selectRange) {
        ...
        if (!getIsSingleValue(previousValue)) {
          ...
          // Second value
          nextValue = (0, _dates.getValueRange)(
            valueType,
            previousValue,
            value
          );
    ...
    _defineProperty(_assertThisInitialized(_this), "onClickTile", function (
      value,
      event
    ) {
    ...
    },
    {
      ...
      value: function renderContent(next) {
        ...
        var activeStartDate = next
          ? (0, _dates.getBeginNext)(view, currentActiveStartDate)
          : (0, _dates.getBegin)(view, currentActiveStartDate);
              ...
              _extends(
                {
                  ...
                  showFixedNumberOfWeeks:
                    showFixedNumberOfWeeks || showDoubleView,
    ...
    },
    {
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ _react["default"].createElement(
          "div",
          {
            className: (0, _mergeClassNames["default"])(
              baseClassName,
              selectRange &&
                valueArray.length === 1 &&
...
var isLooseValue = _propTypes["default"].oneOfType([
...
Calendar.propTypes = {
  ...
  tileClassName: _propTypes["default"].oneOfType([
    _propTypes["default"].func,
    _propTypes2.isClassName
  ]),
  tileContent: _propTypes["default"].oneOfType([
    _propTypes["default"].func,
