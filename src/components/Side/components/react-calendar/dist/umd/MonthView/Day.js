  ...
  return /*#__PURE__*/ _react["default"].createElement(
    ...
    _extends({}, otherProps, {
      classes: [].concat(
        classes,
        className,
        (0, _dates.isWeekend)(date, calendarType)
          ? "".concat(className, "--weekend")
          : null,
        date.getMonth() !== currentMonthIndex
          ? "".concat(className, "--neighboringMonth")
          : null
      ),
...
Day.propTypes = _objectSpread(
  _objectSpread({}, _propTypes2.tileProps),
  {},
  {
