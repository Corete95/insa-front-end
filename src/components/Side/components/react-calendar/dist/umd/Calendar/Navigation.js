...
function Navigation(_ref) {
  var activeStartDate = _ref.activeStartDate,
    ...
    formatMonthYear =
      _ref$formatMonthYear === void 0
        ? _dateFormatter.formatMonthYear
        : _ref$formatMonthYear,
    _ref$formatYear = _ref.formatYear,
    formatYear =
      _ref$formatYear === void 0 ? _dateFormatter.formatYear : _ref$formatYear,
    locale = _ref.locale,
  ...
  var previousActiveStartDate = (0, _dates.getBeginPrevious)(
    view,
    activeStartDate
  );
  var previousActiveStartDate2 =
    shouldShowPrevNext2Buttons &&
    (0, _dates.getBeginPrevious2)(view, activeStartDate);
  var nextActiveStartDate = (0, _dates.getBeginNext)(view, activeStartDate);
  var nextActiveStartDate2 =
    shouldShowPrevNext2Buttons &&
    (0, _dates.getBeginNext2)(view, activeStartDate);
  ...
  var prevButtonDisabled = (function () {
    ...
    var previousActiveEndDate = (0, _dates.getEndPrevious)(
      view,
      activeStartDate
    );
  ...
  var prev2ButtonDisabled =
    ...
    (function () {
      ...
      var previousActiveEndDate = (0, _dates.getEndPrevious2)(
        view,
        activeStartDate
      );
      return minDate && minDate >= previousActiveEndDate;
    ...
    prev2Label !== null &&
      ...
      /*#__PURE__*/ _react["default"].createElement(
        "button",
        {
          ...
          className: ""
            .concat(className, "__arrow ")
            .concat(className, "__prev2-button"),
    ...
    prevLabel !== null &&
      /*#__PURE__*/ _react["default"].createElement(
        "button",
        {
          ...
          className: ""
            .concat(className, "__arrow ")
            .concat(className, "__prev-button"),
    ...
    nextLabel !== null &&
      /*#__PURE__*/ _react["default"].createElement(
        "button",
        {
          ...
          className: ""
            .concat(className, "__arrow ")
            .concat(className, "__next-button"),
    ...
    next2Label !== null &&
      ...
      /*#__PURE__*/ _react["default"].createElement(
        "button",
        {
          ...
          className: ""
            .concat(className, "__arrow ")
            .concat(className, "__next2-button"),
