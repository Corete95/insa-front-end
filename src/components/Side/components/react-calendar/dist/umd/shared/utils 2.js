...
function getTileClasses() {
  ...
  var now = new Date();
  var dateRange =
    date instanceof Array ? date : (0, _dates.getRange)(dateType, date);
  ...
  var valueRange =
    value instanceof Array ? value : (0, _dates.getRange)(valueType, value);
  ...
  if (hover) {
    var hoverRange =
      hover > valueRange[1] ? [valueRange[1], hover] : [hover, valueRange[0]];
